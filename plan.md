...
- API: `POST /provider` with `{ "provider": "anthropic", "model": "claude-sonnet-4-5-20251001" }` or `{ "provider": "cerebras", "model": "llama-4-scout-17b-16e-instruct" }`. Returns the new active config.
